...
public static class Palette
{
    ...
    private static readonly Color[] NetworksDark =
    {
        ...
        Rgb(0x5A, 0xD1, 0xD6), Rgb(0xFF, 0x9E, 0xCF), Rgb(0xD1, 0x9A, 0x66), Rgb(0xA6, 0xB0, 0xC2)
    };
    ...
    private static readonly Color[] NetworksLight =
    {
        ...
        Rgb(0x00, 0xB5, 0xBD), Rgb(0xE0, 0x3F, 0x92), Rgb(0xA8, 0x62, 0x1E), Rgb(0x5B, 0x6B, 0x80)
    };
